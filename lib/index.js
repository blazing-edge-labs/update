...
var change = function change(key, val, data, original, dataIsArray, removeLater) {
...
var purgeArray = function purgeArray(array) {
...
var mapProps = function mapProps(data, f) {
  var ret = data || {};
...
var toPathPart = function toPathPart(part) {
